...
curl -Ss https://github.com/augustash/magento2-module-demo-ribbon/archive/1.1.1.tar.gz | tar xf - --strip 1 -C app/code/Augustash/DemoRibbon/
...
composer require augustash/module-demo-ribbon:~1.1.1
bin/magento module:enable --clear-static-content Augustash_DemoRibbon
bin/magento setup:upgrade
bin/magento cache:flush
```
